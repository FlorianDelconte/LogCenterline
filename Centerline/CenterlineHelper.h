...
public:
    ...
    computeCenterline(const std::vector<Z3i::RealPoint> &points, const double &voxelSize,
        ...
        //std::cout<<"search radisu : "<<searchRadius<<std::endl;
        ...
        //IOHelper::export2Text(smoothLine, "smoothLine.xyz");
        return smoothLine;
    }

    static
    std::vector<Z3i::RealPoint>
    computeCenterlineNor(const std::vector<Z3i::RealPoint> &points,const std::vector<Z3i::RealPoint> normals, const double &voxelSize, double resolution,
            double searchRadius, double accRadius, const int &nbControlPoint, const int &nbSegment, double confThreshold) {
